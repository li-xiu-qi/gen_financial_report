...
def safe_convert_to_docx(md_file: str, docx_file: str = None) -> bool:
    ...
    try:
        ...
        if docx_file is None:
            ...
            docx_file = os.path.join(reports_dir, "Company_Research_Report.docx")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="生成公司研究报告",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
使用示例:
  python run_company_research_report.py --company_name "商汤科技" --company_code "00020.HK"
  python run_company_research_report.py --company_name "4Paradigm"
  python run_company_research_report.py --company_name "4Paradigm" --to_docx
  python run_company_research_report.py --company_name "4Paradigm" --to_docx --docx_output "reports/4paradigm.docx"
  uv run run_company_research_report.py --company_name "4Paradigm"
        """,
    )

    parser.add_argument("--company_name", required=True, help="公司名称")
    ...
    if args.company_code:
        cmd.extend(["--company_code", args.company_code])
        ...
        if result.returncode == 0 and args.to_docx:
            ...
            if args.output:
                ...
                md_file = os.path.join(
                    data_directory, f"{args.company_name}_research_report.md"
                )
